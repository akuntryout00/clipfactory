...
| **B-roll** | grid with thumbnails, usage counts, category filter, search; **Add video** (upload one clip into a category with description/tags/approval); click a clip → preview + edit tags/action/location/shot/mood/quality/usable range/approved, or delete it; Import folder, Enrich with AI |
